            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div align="right"><a href="<?php echo e(route('clientes.create')); ?>" class="btn btn-success">Novo</a></div>
                    </div>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <?php $__currentLoopData = $clientes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $c): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <tr align="center">
                                    ...
                                    <td align="left"><?php echo e($c->email); ?></td>
                                    <td>
                                        <a class="btn btn-small btn-info" href="<?php echo e(route('clientes.show',$c->id)); ?>" >
                                            <i class="fa fa-search-plus"></i>
                                            Detalhes
                                        </a>

                                        <a class="btn btn-small btn-warning" href="<?php echo e(route('clientes.edit',$c->id)); ?>" >
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form id="formDelete<?php echo e($c->id); ?>"
                                                              action="<?php echo e(action('ClienteController@destroy',$c->id)); ?>" method="POST">
