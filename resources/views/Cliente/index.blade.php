            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        ...
                        <div align="right"><a href="{{route('clientes.create')}}" class="btn btn-success">Novo</a></div>
                    </div>
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            @foreach($clientes as $c)
                                <tr align="center">
                                    ...
                                    <td>
                                        <a class="btn btn-small btn-info" href="{{route('clientes.show',$c->id)}}" >
                                            <i class="fa fa-search-plus"></i>
                                            Detalhes
                                        </a>

                                        <a class="btn btn-small btn-warning" href="{{route('clientes.edit',$c->id)}}" >
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form id="formDelete{{ $c->id }}"
                                                              action="{{action('ClienteController@destroy',$c->id)}}" method="POST">
