    ...
    <div class="container-fluid spark-screen">
        <div class="row">
            ...
            <div class="col-md-8 col-md-offset-2">
                ...
                <div class="box">
                    <div class="box-header with-border">
                        <h3 class="box-title">Edição da cidade de <?php echo e($cidade->nome); ?></h3>
                    ...
                    <div class="box-body">
                        ...
                        <form class="form-horizontal" action="<?php echo e(route('cidades.update',$cidade->id)); ?>" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="nome" value="<?php echo e($cidade->nome); ?>" type="text" class="form-control input-lg"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input name="sigla" value="<?php echo e($cidade->sigla); ?>" type="text" class="form-control input-lg"
                                ...
                                <div class="col-sm-10">
                                    <select name="estado" id="estado" class="form-control">
                                        <?php $__currentLoopData = $estado; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $e): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($e->id); ?>" <?php echo e($e->id === (isset($cidade->estado_id) ? $cidade->estado_id : '' ) ? 'selected' : ''); ?>><?php echo e($e->nome); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
